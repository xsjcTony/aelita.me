...
const Lamp: FC<LampProps> = ({ className }) => (
  ...
  >
    ...
    <motion.div
      ...
      whileInView={{ width: 'var(--expanded-width)' }}
    />

    {/* Aura */}
    <div className="absolute z-50 blur-3xl h-144 w-[11rem] translate-y-1/4 rounded-full opacity-50 bg-gradient-to-r from-primary from-50% to-secondary to-50%" />
